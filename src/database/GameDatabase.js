...
export const CardTypes = [
    ...
    new CardType('ancient', 'Ancient', 50*P, 50*B, 'src/img/ancient.png'),
    
    new CardType('eternal', 'Eternal', 5*E, 2*T, 'src/img/eternal.png'),
    new CardType('void', 'Void', 500*E, 100*T, 'src/img/void.png'),
    new CardType('cosmic', 'Cosmic', 75*Z, 5*P, 'src/img/cosmic.png'),
    new CardType('galactic', 'Galactic', 10*Y, 250*P, 'src/img/galactic.png'),
    new CardType('universal', 'Universal', 500*Y, 15*E, 'src/img/universal.png'),
    
    new CardType('multiversal', 'Multiversal', 25*K*Y, 1*Z, 'src/img/multiversal.png'),
    new CardType('dimension', 'Dimension', 1*M*Y, 50*Z, 'src/img/dimension.png'),
    new CardType('temporal', 'Temporal', 100*M*Y, 5*Y, 'src/img/temporal.png'),
    new CardType('infinity', 'Infinity', 1*B*Y, 250*Y, 'src/img/infinity.png'),
    new CardType('source', 'The Source', 1*T*Y, 10*K*Y, 'src/img/source.png'),
];
